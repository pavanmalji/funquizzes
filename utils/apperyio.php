...
class apperyio {
    ...
    private function do_get($url, $sessiontoken=NULL) {
        ...
        $httpheaders = array();
        array_push($httpheaders, 'X-Appery-Database-Id: 56578bd3e4b0c14e6b3c2e9a');
    ...
    function get_session() {
        return self::do_get('https://api.appery.io/rest/1/db/login?username=' . urlencode('superadmin') . '&password='. urlencode('superadmin@123'));
    }
